  ...
  return (
    <PageShell>
      <PageHero
        ...
        description="At Accountables, quality, trust, and security are at the heart of everything we do. As a finance and accounting partner, we understand that our clients rely on us not only for technical expertise but also for consistency, accuracy, and the secure handling of their information."
      />
      ...
      <section className="py-16 md:py-24 border-b border-[var(--border)]">
        <div className="mx-auto max-w-7xl px-6 md:px-10">
          <div className="grid lg:grid-cols-2 gap-5 md:gap-6">
            {/* Quality Management */}
            <div className="card p-7 md:p-8 flex flex-col gap-5">
              <div className="flex items-center gap-3">
                ...
                <h2 className="text-[19px] font-semibold text-[var(--text-primary)]">Quality Management</h2>
              </div>
            ...
            <div className="card p-7 md:p-8 flex flex-col gap-5">
              <div className="flex items-center gap-3">
                ...
                <h2 className="text-[19px] font-semibold text-[var(--text-primary)]">Information Security</h2>
              </div>
              <p className="text-[14px] leading-[1.7] text-[var(--text-secondary)]">
        ...
        <div className="mx-auto max-w-7xl px-6 md:px-10">
          <div className="rounded-[24px] md:rounded-[32px] border border-[var(--border)] bg-white p-8 md:p-12">
            ...
            <div className="mt-5 flex flex-col gap-3 max-w-3xl">
              ...
              <p className="text-[15px] leading-[1.7] font-medium text-[var(--text-primary)]">
