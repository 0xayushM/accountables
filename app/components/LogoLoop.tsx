            ...
            {isVertical ? (
              <>
                <div
                  ...
                  style={{
                    background:
                      "linear-gradient(to bottom, var(--logoloop-fadeColor, var(--background)) 0%, rgba(0,0,0,0) 100%)",
                  }}
                />
                <div
                  aria-hidden
                  ...
                  style={{
                    background:
                      "linear-gradient(to top, var(--logoloop-fadeColor, var(--background)) 0%, rgba(0,0,0,0) 100%)",
                  }}
                />
              </>
            ) : (
              <>
                <div
                  ...
                  style={{
                    background:
                      "linear-gradient(to right, var(--logoloop-fadeColor, var(--background)) 0%, rgba(0,0,0,0) 100%)",
                  }}
                />
                <div
                  aria-hidden
                  ...
                  style={{
                    background:
                      "linear-gradient(to left, var(--logoloop-fadeColor, var(--background)) 0%, rgba(0,0,0,0) 100%)",
                  }}
                />
              </>
            )}
